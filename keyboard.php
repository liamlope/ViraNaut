...
$datatextbot = array(
    ...
    'text_start' => $textbotlang['textbot']['start'] ?? '',
    'text_bot_off' => $textbotlang['textbot']['botOff'] ?? '',
    'text_dec_info' => '',
    'text_dec_usertest' => '',
    'text_fq' => $textbotlang['textbot']['faq'] ?? '',
    'accountwallet' => $textbotlang['textbot']['accountWallet'] ?? '',
    'text_sell' => $textbotlang['textbot']['sell'] ?? '',
    'text_Add_Balance' => $textbotlang['textbot']['addBalance'] ?? '',
    'text_Discount' => $textbotlang['textbot']['discount'] ?? '',
    'text_Tariff_list' => $textbotlang['textbot']['tariffList'] ?? '',
    'text_affiliates' => $textbotlang['textbot']['affiliates'] ?? '',
    'carttocart' => $textbotlang['textbot']['cartToCart'] ?? '',
    'textnowpayment' => $textbotlang['textbot']['nowPayment'] ?? '',
    'textnowpaymenttron' => $textbotlang['textbot']['nowPaymentTron'] ?? '',
    'iranpay1' => $textbotlang['textbot']['iranPay1'] ?? '',
    'iranpay2' => $textbotlang['textbot']['iranPay2'] ?? '',
    'iranpay3' => $textbotlang['textbot']['iranPay3'] ?? '',
    'aqayepardakht' => $textbotlang['textbot']['aqayePardakht'] ?? '',
    'zarinpal' => $textbotlang['textbot']['zarinpal'] ?? '',
    'textpaymentnotverify' => $textbotlang['textbot']['paymentNotVerify'] ?? '',
    'textrequestagent' => $textbotlang['textbot']['requestAgent'] ?? '',
    'textpanelagent' => $textbotlang['textbot']['agentPanel'] ?? '',
    'text_wheel_luck' => $textbotlang['textbot']['wheelLuck'] ?? '',
    'text_star_telegram' => $textbotlang['textbot']['starTelegram'] ?? '',
    'text_extend' => $textbotlang['textbot']['extend'] ?? '',
    'textsnowpayment' => $textbotlang['textbot']['snowPayment'] ?? '',
    'text_cart' => $textbotlang['textbot']['cart'] ?? '',
    'text_cart_auto' => $textbotlang['textbot']['cartAuto'] ?? '',
    'textselectlocation' => $textbotlang['textbot']['selectLocation'] ?? '',
);
...
$optionX_ui_single = json_encode([
    'keyboard' => [
        [['text' => "🎯 انتخاب اینباندها"], ['text' => "🔑 توکن API پنل (3x-ui)"]],
        [['text' => "🔄 تست اتصال"]],
        [['text' => "⚙️ وضعیت قابلیت ها پنل"]],
        [['text' => "✍️ نام پنل"], ['text' => "❌ حذف پنل"]],
        [['text' => "🔐 ویرایش رمز عبور"], ['text' => "👤 ویرایش نام کاربری"]],
