...
try {
    ...
    if (!$tableExists) {
        ...
        addFieldToTable($tableName, 'Processing_value_two', null, "LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
        ...
        try {
            // Old schemas may have Processing_value_two as short VARCHAR and crash on x-ui inbound cache payload.
            $pdo->exec("ALTER TABLE `$tableName` MODIFY `Processing_value_two` LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL");
        } catch (PDOException $e) {
            file_put_contents('error_log user', 'Failed to alter Processing_value_two: ' . $e->getMessage());
        }
    }
} catch (PDOException $e) {
...
💵بعد از تایید پرداختتون توسط ادمین کیف پول شما شارژ خواهد شد و در صورتی که سفارشی داشته باشین انجام خواهد شد";
    $textcartauto = "💳 <b>شارژ کیف پول · تأیید خودکار</b>
