...
2. گروه تلگرام بسازید → ربات فروش را Admin کنید → BotFather → Group Privacy = خاموش  
3. آیدی گروه را از **@IDFindeerBot** بگیرید و در پنل ذخیره کنید  
4. اپ **SMS Forwarder** روی گوشی → پیامک بانک را به همان گروه بفرستد  
5. کاربر باید **دقیقاً مبلغ یکتای فاکتور** را واریز کند  
