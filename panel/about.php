    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="field-hint" style="margin-top:16px">
                ویرانات (ViraNaut) جایگزین برند قبلی است. این پروژه برای مدیریت ربات VPN، مینی‌اپ تلگرام، درگاه‌های پرداخت و پنل ادمین طراحی شده است.
            </p>
