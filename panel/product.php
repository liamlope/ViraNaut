          ...
          foreach ($products as $p): ?>
            <tr>
              ...
              <td class="cm" style="font-size:.68rem;max-width:90px" title="<?= htmlspecialchars((string) ($p['inbounds'] ?? '')) ?>">
                <?= !empty($p['inbounds']) && $p['inbounds'] !== 'null' ? htmlspecialchars(trunc((string) $p['inbounds'], 14)) : '—' ?>
              </td>
              <td>
      ...
      <div class="modal-body">
        ...
        <div class="form-grid">
          ...
          <div class="field">
            ...
            <select name="cetegory_product" id="add_cat" class="select">
              <option value="">— بدون دسته —</option>
              <?php foreach ($categories as $c): ?>
                <option value="<?= htmlspecialchars($c['remark']) ?>"><?= htmlspecialchars($c['remark']) ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="field">
            <label>پنل</label>
            <select name="namepanel" id="add_panel" class="select">
          ...
          <div class="field full">
            <label>اینباند (3x-ui)</label>
            <input type="hidden" name="inbounds_product" id="add_inbounds" value="">
            <div id="add_inbound_picker" class="inbound-picker-box"></div>
          </div>
          <div class="field full">
            <label>توضیحات</label>
    ...
    <form method="POST">
      <div class="modal-body">
        ...
        <div class="form-grid">
          ...
          <div class="field full">
            <label>اینباند (3x-ui)</label>
            <input type="hidden" name="inbounds_product" id="edit_inbounds" value="">
            <div id="edit_inbound_picker" class="inbound-picker-box"></div>
          </div>
          <div class="field full">
            <label>توضیحات</label>
