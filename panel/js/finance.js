            ...
            if (gen) {
                gen.innerHTML = (d.general || []).map(function (g) {
                    if (g.options) {
                        ...
                        return '<label class="field"><span class="field-label">' + g.label + '</span><select class="select gen-f" data-k="' + g.key + '">' + opts + '</select></label>';
                    }
                    ...
                    return '<label class="field"><span class="field-label">' + g.label + '</span>' + inp + '</label>';
                }).join('');
            }
